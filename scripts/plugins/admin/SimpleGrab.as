...
void PluginInit()
{
  ...
  @g_pThinkFunc = g_Scheduler.SetInterval("grabthink", 0.005f);
...
void Grab( const CCommand@ pArgs )
{
  ...
  if (valueKeyGrab.GetInteger() > 0)
  {
    ...
    if( pEntity !is null )
    {
      ...
      g_PlayerFuncs.ClientPrint( pPlayer, HUD_PRINTTALK, "UNGRAB: (" + pEntity.pev.classname + ") - [X: " + pEntity.pev.origin.x + "|Y: "+pEntity.pev.origin.y+" |Z: "+pEntity.pev.origin.z + "]" );
  ...
  } else
  {
    ...
    if( pEntity !is null && pEntity.pev.classname != "worldspawn")
    {
      ...
      g_PlayerFuncs.ClientPrint( pPlayer, HUD_PRINTTALK, "GRAB:     (" + pEntity.pev.classname + ") - [X: " + pEntity.pev.origin.x + "|Y: "+pEntity.pev.origin.y+" |Z: "+pEntity.pev.origin.z + "]" );
